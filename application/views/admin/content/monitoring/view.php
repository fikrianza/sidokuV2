					...
					<tbody>
					 <?php $count=1; foreach($list_disposisi as $x){ ?>
					  <tr>
						...
						<td><?php echo $x->perihal_surat ?></td>
						<td><?php echo $x->created_date ?></td>
						<td>
						  <a href="<?php  echo base_url('admin/monitoring/detail/'.$x->id_surat); ?>"><button class="btn btn-primary"> Lihat Status Monitoring</button></a>
						</td>
					  </tr>
					 <?php $count++; } ?>
					</tbody>
