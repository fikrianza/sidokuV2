                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="well" style="background-color:white">
                     <h4>
                       Anda yakin ingin menghapus data <b><?php echo $x->nama ?></b> ? 
                      </h4>
                      <form action="<?php echo base_url('admin/user/delete/'.$x->id_user) ?>" method="post">
                        <button type="submit" class="btn btn-danger"><i class="fa fa-trash-o"></i> Hapus </button>
                        <a href="<?php echo base_url('admin/user') ?>"><button type="button" class="btn btn-default"><i class="fa fa-times"></i> Batalkan </button></a>
                      </form>
                    </div>
                  </div>
                </div>      
